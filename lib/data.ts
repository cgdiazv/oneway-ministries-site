...
export const newsData: NewsItem[] = [
  ...
  },
  {
    ...
    image: "/new-community-center-opening.webp",
  ...
  },
  {
    ...
    image: "/annual-fundraising-gala-results.webp",
  ...
  },
  {
    ...
    image: "/mission-trip-to-amazon-region.webp",
  ...
  },
  {
    ...
    image: "/back-to-school-drive-success.webp",
  ...
  },
  {
    ...
    image: "/partnering-with-local-healthcare-providers.webp",
  ...
  },
  {
    ...
    image: "/youth-soccer-tournament-brings-community-together.webp",
...
export const ministriesData: MinistryItem[] = [
  ...
  },
  {
    ...
    fullDescription: "<p>Ada Orozco, Bridman and Yulih Alarca, joined this ministry in 2022 and One Way took over in 2024.</p><p>Casa del Rey ministers primarily to individuals seeking restoration from drug addtion, discipleship, and spiritual renewal. Through regular visits, Bible teaching, worship, fellowship, and practical encouragement, the ministry creates spaces where participants can ask difficult questions, grow in biblical understanding, and experience authentic Christian community.<p><p>Together with Shalom Church, this ministry emphasizes ongoing discipleship and holistic support—not only ministering to participants but also encouraging ministry leaders and families carrying heavy pastoral responsibilities. The goal is to cultivate lasting transformation through Gospel-centered relationships, biblical truth, and consistent spiritual care.</p>",
  ...
  },
  {
    ...
    fullDescription: "<p>Jhony Ramirez and Zoraya Lopez joined this ministry in 2023 and One Way agreed to unite with them in 2024.</p><p>Located in the Colombian Amazon, the Guainía ministry serves indigenous communities through biblical teaching, leadership training, discipleship, and pastoral care. Working alongside local pastors, this ministry seeks to strengthen churches in remote regions while equipping believers with sound biblical foundations. Workshops on hermeneutics, worship, and leadership development help local congregations grow in maturity and establish healthier ministry practices rooted in Scripture.</p><p>Beyond church strengthening, the vision of Guainía extends toward reaching isolated indigenous communities and raising future leaders for Gospel ministry. The work involves cross-cultural missions, long journeys through river and jungle regions, and ongoing efforts to establish sustainable places of worship and discipleship. This ministry represents a long-term commitment to seeing indigenous churches flourish and communities transformed by Christ.</p>",
  ...
  },
  {
    ...
    fullDescription: "<p>Sebastian Rodriguez began working with Impacto in 2020 and One Way agree join them in 2024.</p><p>Impacto Bíblico uses evangelistic outreach—including large-scale film presentations—to bring the Gospel into communities throughout Santa Marta. These events often attract hundreds of people and create opportunities for follow-up discipleship and integration into local churches.</p><p>At the same time, the Cristo Rey church planting initiative is building relationships in a vulnerable neighborhood where leaders, youth teams, and volunteers are investing in children, families, and emerging believers. The long-term vision is to establish a healthy local church rooted in discipleship and sustained by trained leaders living among the community.</p>",
