...
export const ministriesData: MinistryItem[] = [
  ...
  */
  ...
  },
  {
    ...
    fullDescription: "<p>Sebastian Rodriguez began working with Edison in 2021.  One Way agreed to join this ministry in 2026</p><p><strong>Calvary Church</strong> in Santa Marta uses soccer as a bridge to reach children and families with the Gospel. Through sports programs, food assistance, and home visits, relationships are developed that open doors for discipleship and spiritual conversations.</p><p>The ministry recognizes that meaningful transformation often begins with consistent presence and practical support. By serving both children and their families, <strong>Calvary Church</strong> seeks to build community, strengthen faith, and demonstrate Christ’s love in tangible ways.</p>",
  ...
  },
  {
    ...
    fullDescription: "<p>Sebastian Rodriguez began working with Unidos in 2020 and One Way agree to join them in 2024.</p><p><strong>Misión Unidos</strong> uses sports, music, recreation, crafts, and Bible teaching as tools to reach children and youth in Santa Marta. Every week, dozens of children participate in activities designed to provide a safe environment, encouragement, and exposure to the Gospel.</p><p>The ministry also seeks to impact families by connecting them to the local church and creating opportunities for long-term discipleship. In communities where instability and harmful influences are common, <strong>Misión Unidos</strong> offers consistency, mentorship, and hope through Christ-centered relationships.</p>",
  ...
  },
  {
    ...
    fullDescription: "<p>One Way joined with Alvaro in 2026.</p><p><strong>Misión Wayuu</strong> serves indigenous communities in the desert regions of La Guajira through biblical training, leadership development, pastoral support, and missionary preparation. The ministry operates in isolated areas where access to resources is limited, yet opportunities for Gospel impact are significant.</p><p>A central vision of the ministry is to equip indigenous believers and establish missionary training centers that will prepare future leaders to serve among the Wayuu people. Through long-term discipleship and cross-cultural ministry, <strong>Misión Wayuu</strong> seeks to see entire communities transformed and indigenous churches strengthened for generations to come.</p>",
